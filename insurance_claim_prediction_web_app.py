...
def main(): 
    ...
    user_input_str = st.text_input('Enter all the feature values separated by comma')
     
    #string to list
    user_input = user_input_str.split(",")
    
    for x, ele in enumerate(user_input):
        if x==12: ps_ind_12_bin = ele
        if x==39: ps_calc_02 = ele
        if x==7: ps_ind_07_bin = ele
        if x==15: ps_ind_15 = ele
        if x==29: ps_car_08_cat = ele
        if x==23: ps_car_02_cat = ele
        if x==35: ps_car_13 = ele
        if x==28: ps_car_07_cat = ele
        if x==25: ps_car_04_cat = ele
        if x==36: ps_car_14 = ele
        if x==2: ps_ind_02_cat = ele
        if x==17: ps_ind_17_bin = ele
        if x==33: ps_car_11 = ele
        if x==18: ps_ind_18_bin = ele
        if x==34: ps_car_12 = ele
        if x==4: ps_ind_04_cat = ele
        if x==21: ps_reg_03 = ele
        if x==19: ps_reg_01 = ele
        if x==37: ps_car_15 = ele
        if x==38: ps_calc_01 = ele
        if x==30: ps_car_09_cat = ele
        if x==14: ps_ind_14 = ele
        if x==16: ps_ind_16_bin = ele
        if x==5: ps_ind_05_cat = ele
        if x==11: ps_ind_11_bin = ele
        if x==1: ps_ind_01 = ele
        if x==20: ps_reg_02 = ele
        if x==8: ps_ind_08_bin = ele
        if x==31: ps_car_10_cat = ele
        if x==24: ps_car_03_cat = ele
        if x==26: ps_car_05_cat = ele
        if x==22: ps_car_01_cat = ele
        if x==27: ps_car_06_cat = ele
        if x==40: ps_calc_03 = ele
        if x==10: ps_ind_10_bin = ele
        if x==6: ps_ind_06_bin = ele
        if x==3: ps_ind_03 = ele
        if x==9: ps_ind_09_bin = ele
